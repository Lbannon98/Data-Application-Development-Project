...
cat output/Top10ForestFiresByMonthAndYearMapper_output.txt | python Top10ForestFiresByMonthAndYearReducer.py

cat output/Top10ForestFiresByMonthAndYearMapper_output.txt | python Top10ForestFiresByMonthAndYearReducer.py > output/Top10ForestFiresByMonthAndYearReducer_output.txt
